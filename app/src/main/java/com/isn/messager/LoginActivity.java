...
public class LoginActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMobileView = (EditText) findViewById(R.id.log_mobile);
        ...
        Button mRegisterButton = (Button) findViewById(R.id.to_register_button);
        ...
        Button mLoginButton = (Button) findViewById(R.id.mobile_login_button);
    ...
    public class UserLoginTask extends AsyncTask<Void, Void, Boolean> {
        ...
        protected void onPostExecute(final Boolean success) {
            ...
            if (success) {
                ...
                if(result == -1) {
                    mMobileView.setError(getString(R.string.error_user_no_exist));
                    ...
                    Snackbar.make(mLoginFormView, R.string.error_login_failed, Snackbar.LENGTH_LONG)
